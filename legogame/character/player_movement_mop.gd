extends State
class_name player_movement_bookcarry
var friction = 20
...
func enter():
	...
	$"../../Control/NOTIF/MOP".start()
	bar_parent.show()
	$"../../persik/Armature_001/Skeleton3D/CSGBox3D".show()
	$"../../persik/Armature_001/Skeleton3D/BoneAttachment3D2".show()
	animation_player.set("parameters/mop/blend_amount",1)
...
func Physics_Update(delta):
	go = clamp(go,-1.0,1.0)
	bar.rotation = remap(go,-1.0,1.0,-1.0,1.0)
	if go==1.0: 
		Transitioned.emit(self, "movement")
		Done_state_.emit("MOP")
	# Handle jump.
...
func exit():
	...
	$"../../persik/Armature_001/Skeleton3D/CSGBox3D".hide()
	$"../../persik/Armature_001/Skeleton3D/BoneAttachment3D2".hide()
	animation_player.set("parameters/mop/blend_amount",0)
	bar_parent.hide()
	pass
