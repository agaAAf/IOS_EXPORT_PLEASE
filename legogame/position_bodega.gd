...
func _ready() -> void:
	first_position = $"../../Camera3D".position
	first_rotation = $"../../Camera3D".rotation
...
func animation_menu_play():
	$"../../Node3D21/Node3D20".show()
	$"../../Node3D21/AnimationPlayer".play("FLIP_BODEGA")
	
func animation_menu_back():
	$"../../Node3D21/Node3D20".hide()
	$"../../Node3D21/AnimationPlayer".play_backwards("FLIP_BODEGA")
