...
func _is_point_inside_joystick_area(point: Vector2) -> bool:
	print(str(global_position)+ "JS")
	print(str(point)+" POINT")
	print(str(global_position.x+get_global_transform_with_canvas().get_scale().x)+" "+str(global_position.y+get_global_transform_with_canvas().get_scale().y)+ "JS")
